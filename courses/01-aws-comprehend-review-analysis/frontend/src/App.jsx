    ...
    <div style={{ 
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginTop: '8px', marginBottom: '16px', flexWrap: 'wrap' }}>
        ...
        <div style={{ display: 'flex', gap: '12px' }}>
          <a href="https://www.youtube.com/@learn_ai_enterprise_careers" target="_blank" rel="noopener noreferrer" style={{ color: '#FF0000', textDecoration: 'none' }} title="YouTube">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
            </svg>
          </a>
          <a href="https://www.instagram.com/darius.arian.fit" target="_blank" rel="noopener noreferrer" style={{ color: '#E4405F', textDecoration: 'none' }} title="Instagram">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="https://www.linkedin.com/in/sajad-rahmdel" target="_blank" rel="noopener noreferrer" style={{ color: '#0A66C2', textDecoration: 'none' }} title="LinkedIn">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div style={{ 
              ...
              <Geographies geography={geoUrl}>
                {({ geographies }) => {
                  ...
                  return geographies.map((geo) => {
                    ...
                    for (const [reviewCountry, geoNames] of Object.entries(countryMapping)) {
                      if (geoNames.includes(countryName) && countryColors[reviewCountry]) {
                        fillColor = countryColors[reviewCountry];
                        matchedCountry = reviewCountry;
                        break;
                      }
                    }

                    const sentimentData = matchedCountry ? countrySentiment[matchedCountry] : null;
          ...
          <ResponsiveContainer width="100%" height={300} minWidth={0}>
            <BarChart data={(() => {
              ...
              results.analysis_results.forEach(item => {
                // Check entities from Comprehend
                item.entities?.forEach(entity => {
              ...
              // If no locations found from entities, use country from metadata
